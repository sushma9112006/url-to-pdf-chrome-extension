...
Open any normal website such as a blog, documentation page, or article.
...
Go to the top-right corner of the browser toolbar.
...
**Option A: Convert the currently open page**

Leave the URL input field empty.
Optionally enter a filename.
Click Open Print (Save as PDF).

**Option B: Convert a different page**

Paste a valid URL into the URL input field.
Optionally enter a filename.
Click Open Print (Save as PDF).
